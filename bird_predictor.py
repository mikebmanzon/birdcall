...
# bird label: encoded label value
...
def extract_features(audio):
    """
    Parameter: audio - librosa audio file
    Returns: np.array of mfccs
    """
...
def make_prediction(song):
    """
    Parameter: song - librosa audio file
    Returns: predicted bird type (int)
    """
...
def display_spect(audio):
    """
    Parameter: audio - librosa audio file
    Returns: figure - matplotlib figure of spectrogram
    """
...
def play_song(file_name):
    ...
    Returns: nothing
    Does: displays audio player in Streamlit
    """
...
def show_bird(prediction):
    """
    Parameter: prediction - predicted bird (int)
    Returns: nothing
    Does: tries to find and display a photo of predicted bird
    """
    try: 
